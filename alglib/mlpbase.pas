...
procedure MLPCreate2(NIn: AlglibInteger; NHid1: AlglibInteger; NHid2: AlglibInteger; NOut: AlglibInteger;
  var Network: MultiLayerPerceptron);
procedure MLPCreateB0(NIn: AlglibInteger; NOut: AlglibInteger; B: AlglibFloat; D: AlglibFloat;
  var Network: MultiLayerPerceptron);
procedure MLPCreateB1(NIn: AlglibInteger; NHid: AlglibInteger; NOut: AlglibInteger; B: AlglibFloat; D: AlglibFloat;
  var Network: MultiLayerPerceptron);
...
procedure MLPCreateB3(NIn: AlglibInteger; NHid1, NHid2, NHid3: AlglibInteger; NOut: AlglibInteger;
  B: AlglibFloat; D: AlglibFloat; var Network: MultiLayerPerceptron);
procedure MLPCreateB3_N(NIn: AlglibInteger; NHid1, NHid2, NHid3, NHidnext, NHidLayersCount: AlglibInteger;
  NOut: AlglibInteger;
  B: AlglibFloat; D: AlglibFloat; var Network: MultiLayerPerceptron);
...
procedure MLPCreateR1(NIn: AlglibInteger; NHid: AlglibInteger; NOut: AlglibInteger; A: AlglibFloat; B: AlglibFloat;
  var Network: MultiLayerPerceptron);
procedure MLPCreateR2(NIn: AlglibInteger; NHid1: AlglibInteger; NHid2: AlglibInteger; NOut: AlglibInteger;
  A: AlglibFloat; B: AlglibFloat; var Network: MultiLayerPerceptron);
procedure MLPCreateC0(NIn: AlglibInteger; NOut: AlglibInteger; var Network: MultiLayerPerceptron);
procedure MLPCreateC1(NIn: AlglibInteger; NHid: AlglibInteger; NOut: AlglibInteger; var Network: MultiLayerPerceptron);
procedure MLPCreateC2(NIn: AlglibInteger; NHid1: AlglibInteger; NHid2: AlglibInteger; NOut: AlglibInteger;
  var Network: MultiLayerPerceptron);
procedure MLPFree(var Network: MultiLayerPerceptron);
procedure MLPCopy(const Network1: MultiLayerPerceptron; var Network2: MultiLayerPerceptron);
procedure MLPSerialize(const Network: MultiLayerPerceptron; var RA: TReal1DArray; var RLen: AlglibInteger); overload;
procedure MLPSerialize(const Network: MultiLayerPerceptron; const aFileName: string); overload;
procedure MLPUnserialize(const RA: TReal1DArray; var Network: MultiLayerPerceptron); overload;
procedure MLPUnserialize(const aFileName: string; var Network: MultiLayerPerceptron); overload;
...
procedure MLPRandomize(var Network: MultiLayerPerceptron; const WBest: TReal1DArray;
  const Diameter: AlglibFloat); overload;
procedure MLPRandomizeFull(var Network: MultiLayerPerceptron);
procedure MLPInitPreprocessor(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger);
procedure MLPProperties(const Network: MultiLayerPerceptron; var NIn: AlglibInteger; var NOut: AlglibInteger;
  var WCount: AlglibInteger);
function MLPIsSoftmax(const Network: MultiLayerPerceptron): Boolean;
procedure MLPProcess(var Network: MultiLayerPerceptron; const X: TReal1DArray; var Y: TReal1DArray);
function MLPError(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger): AlglibFloat;
function MLPErrorN(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger): AlglibFloat;
function MLPClsError(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger): AlglibInteger;
function MLPRelClsError(var Network: MultiLayerPerceptron; const XY: TReal2DArray; NPoints: AlglibInteger): AlglibFloat;
function MLPAvgCE(var Network: MultiLayerPerceptron; const XY: TReal2DArray; NPoints: AlglibInteger): AlglibFloat;
function MLPRMSError(var Network: MultiLayerPerceptron; const XY: TReal2DArray; NPoints: AlglibInteger): AlglibFloat;
function MLPAvgError(var Network: MultiLayerPerceptron; const XY: TReal2DArray; NPoints: AlglibInteger): AlglibFloat;
function MLPAvgRelError(var Network: MultiLayerPerceptron; const XY: TReal2DArray; NPoints: AlglibInteger): AlglibFloat;
procedure MLPGrad(var Network: MultiLayerPerceptron; const X: TReal1DArray; const DesiredY: TReal1DArray;
  var E: AlglibFloat; var Grad: TReal1DArray);
procedure MLPGradN(var Network: MultiLayerPerceptron; const X: TReal1DArray; const DesiredY: TReal1DArray;
  var E: AlglibFloat; var Grad: TReal1DArray);
procedure MLPGradBatch(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger;
  var E: AlglibFloat; var Grad: TReal1DArray);
procedure MLPGradNBatch(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger;
  var E: AlglibFloat; var Grad: TReal1DArray);
procedure MLPHessianNBatch(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger;
  var E: AlglibFloat; var Grad: TReal1DArray; var H: TReal2DArray);
procedure MLPHessianBatch(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger;
  var E: AlglibFloat; var Grad: TReal1DArray; var H: TReal2DArray);
procedure MLPInternalProcessVector(const StructInfo: TInteger1DArray; const Weights: TReal1DArray;
  const ColumnMeans: TReal1DArray; const ColumnSigmas: TReal1DArray; var Neurons: TReal1DArray;
  var DFDNET: TReal1DArray; const X: TReal1DArray; var Y: TReal1DArray);
...
procedure AddInputLayer(NCount: AlglibInteger; var LSizes: TInteger1DArray; var LTypes: TInteger1DArray;
  var LConnFirst: TInteger1DArray; var LConnLast: TInteger1DArray; var LastProc: AlglibInteger); forward;
procedure AddBiasedSummatorLayer(NCount: AlglibInteger; var LSizes: TInteger1DArray; var LTypes: TInteger1DArray;
  var LConnFirst: TInteger1DArray; var LConnLast: TInteger1DArray; var LastProc: AlglibInteger); forward;
procedure AddActivationLayer(FuncType: AlglibInteger; var LSizes: TInteger1DArray; var LTypes: TInteger1DArray;
  var LConnFirst: TInteger1DArray; var LConnLast: TInteger1DArray; var LastProc: AlglibInteger); forward;
procedure AddZeroLayer(var LSizes: TInteger1DArray; var LTypes: TInteger1DArray; var LConnFirst: TInteger1DArray;
  var LConnLast: TInteger1DArray; var LastProc: AlglibInteger); forward;
procedure MLPCreate(NIn: AlglibInteger; NOut: AlglibInteger; const LSizes: TInteger1DArray;
  const LTypes: TInteger1DArray; const LConnFirst: TInteger1DArray; const LConnLast: TInteger1DArray;
  LayersCount: AlglibInteger; IsClsNet: Boolean; var Network: MultiLayerPerceptron); forward;
procedure MLPActivationFunction(NET: AlglibFloat; K: AlglibInteger; var F: AlglibFloat; var DF: AlglibFloat;
  var D2F: AlglibFloat); forward;
procedure MLPHessianBatchInternal(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger;
  NaturalErr: Boolean; var E: AlglibFloat; var Grad: TReal1DArray; var H: TReal2DArray); forward;
procedure MLPInternalCalculateGradient(var Network: MultiLayerPerceptron; const Neurons: TReal1DArray;
  const Weights: TReal1DArray; var DError: TReal1DArray; var Grad: TReal1DArray; NaturalErrorFunc: Boolean); forward;
procedure MLPChunkedGradient(var Network: MultiLayerPerceptron; const XY: TReal2DArray; CStart: AlglibInteger;
  CSize: AlglibInteger; var E: AlglibFloat; var Grad: TReal1DArray; NaturalErrorFunc: Boolean); forward;
function SafeCrossEntropy(T: AlglibFloat; Z: AlglibFloat): AlglibFloat; forward;
...
begin
  LayersCount := 1 + 3 + 3 + 3 + 3;
  for I := 4 to NHidLayersCount do
    LayersCount := LayersCount + 3;
  ...
  AddBiasedSummatorLayer(NHid3, LSizes, LTypes, LConnFirst, LConnLast, LastProc);
  AddActivationLayer(1, LSizes, LTypes, LConnFirst, LConnLast, LastProc);
  // все скрытые слои после 3-го добавл€ютс€ с едиными настройками
  for I := 4 to NHidLayersCount do
  begin
    AddBiasedSummatorLayer(NHidnext, LSizes, LTypes, LConnFirst, LConnLast, LastProc);
    AddActivationLayer(1, LSizes, LTypes, LConnFirst, LConnLast, LastProc);
  end;
  AddBiasedSummatorLayer(NOut, LSizes, LTypes, LConnFirst, LConnLast, LastProc);
  AddActivationLayer(3, LSizes, LTypes, LConnFirst, LConnLast, LastProc);
...
(* ************************************************************************
  ...
  ************************************************************************ *)
procedure MLPSerialize(const Network: MultiLayerPerceptron; var RA: TReal1DArray; var RLen: AlglibInteger);
var
  I: AlglibInteger;
  SSize: AlglibInteger;
  NTotal: AlglibInteger;
...
var
  ...
  RLen: AlglibInteger;
begin
  zMS := TMemoryStream.Create;
  try
    MLPSerialize(Network, RA, RLen);
    if (RLen > 0) then
    begin
      zMS.Write(RA[0], RLen * SizeOf(RA[0]));
      zMS.Position := 0;
      zMS.SaveToFile(aFileName);
    end;
    SetLength(RA, 0);
  finally
    zMS.Free;
...
(* ************************************************************************
  ...
  Copyright 29.03.2008 by Bochkanov Sergey
  ************************************************************************ *)
procedure MLPUnserialize(const RA: TReal1DArray; var Network: MultiLayerPerceptron);
var
  I: AlglibInteger;
  SSize: AlglibInteger;
  NTotal: AlglibInteger;
...
begin
  zMS := TMemoryStream.Create;
  try
    zMS.LoadFromFile(aFileName);
    zMS.Position := 0;
    SetLength(RA, zMS.Size div SizeOf(RA[0]));
    zMS.Read(RA[0], zMS.Size);
...
procedure MLPProcess(var Network: MultiLayerPerceptron; const X: TReal1DArray; var Y: TReal1DArray);
begin
  MLPInternalProcessVector(Network.StructInfo, Network.Weights, Network.ColumnMeans, Network.ColumnSigmas,
    Network.Neurons, Network.DFDNET, X, Y);
end;
...
(* ************************************************************************
  ...
  ************************************************************************ *)
procedure AddInputLayer(NCount: AlglibInteger; var LSizes: TInteger1DArray; var LTypes: TInteger1DArray;
  var LConnFirst: TInteger1DArray; var LConnLast: TInteger1DArray; var LastProc: AlglibInteger);
begin
  LSizes[0] := NCount;
  LTypes[0] := -2;
  LConnFirst[0] := 0;
...
(* ************************************************************************
  ...
  ************************************************************************ *)
procedure AddZeroLayer(var LSizes: TInteger1DArray; var LTypes: TInteger1DArray; var LConnFirst: TInteger1DArray;
  var LConnLast: TInteger1DArray; var LastProc: AlglibInteger);
begin
  LSizes[LastProc + 1] := 1;
  LTypes[LastProc + 1] := -4;
  LConnFirst[LastProc + 1] := 0;
...
procedure MLPCreate(NIn: AlglibInteger; NOut: AlglibInteger; const LSizes: TInteger1DArray;
  const LTypes: TInteger1DArray; const LConnFirst: TInteger1DArray; const LConnLast: TInteger1DArray;
  LayersCount: AlglibInteger; IsClsNet: Boolean; var Network: MultiLayerPerceptron);
var
  I: AlglibInteger;
  J: AlglibInteger;
  SSize: AlglibInteger;
...
(* ************************************************************************
  ...
  ************************************************************************ *)
procedure MLPHessianBatchInternal(var Network: MultiLayerPerceptron; const XY: TReal2DArray; SSize: AlglibInteger;
  NaturalErr: Boolean; var E: AlglibFloat; var Grad: TReal1DArray; var H: TReal2DArray);
var
  NIn: AlglibInteger;
  NOut: AlglibInteger;
  WCount: AlglibInteger;
...
begin
  ...
  begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              dEIdYJ := ExpI * ExpJ / AP_Sqr(S) * (S2 / AP_Sqr(S) - 2 * Z / S - (ExpI + ExpJ) / S +
    ...
    begin
      ...
      begin
        BFlag := False;
        if (Network.StructInfo[Offs + 0] = -2) or (Network.StructInfo[Offs + 0] = -3) or
...
(* ************************************************************************
  ...
  ************************************************************************ *)
procedure MLPInternalCalculateGradient(var Network: MultiLayerPerceptron; const Neurons: TReal1DArray;
  const Weights: TReal1DArray; var DError: TReal1DArray; var Grad: TReal1DArray; NaturalErrorFunc: Boolean);
var
  I: AlglibInteger;
  N1: AlglibInteger;
  N2: AlglibInteger;
...
(* ************************************************************************
  ...
  ************************************************************************ *)
procedure MLPChunkedGradient(var Network: MultiLayerPerceptron; const XY: TReal2DArray; CStart: AlglibInteger;
  CSize: AlglibInteger; var E: AlglibFloat; var Grad: TReal1DArray; NaturalErrorFunc: Boolean);
var
  I: AlglibInteger;
  J: AlglibInteger;
  K: AlglibInteger;
...
begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Network.Chunks[IDError + NTotal - NOut + I, K] := (-V + DEOwn * FOwn + DEOwn * (NET - FOwn)) * FOwn /
            AP_Sqr(NET);
          Inc(I);
        end;
      end;
  ...
  begin
    ...
    begin
      ...
      while J <= CSize - 1 do
      begin
        V := Network.Chunks[NTotal - NOut + I, J] * Network.ColumnSigmas[NIn + I] + Network.ColumnMeans[NIn + I] -
          XY[CStart + J, NIn + I];
  ...
  begin
    ...
    begin
      ...
      while J <= W2 do
      begin
        V := APVDotProduct(@Network.Chunks[N1 + J - W1][0], 0, CSize - 1, @Network.Chunks[IDError + I][0], 0,
          CSize - 1);
        Grad[J] := Grad[J] + V;
        Inc(J);
      end;
...
(* ************************************************************************
  ...
  Internal subroutine.
  ************************************************************************ *)
function SafeCrossEntropy(T: AlglibFloat; Z: AlglibFloat): AlglibFloat;
var
  R: AlglibFloat;
begin
