...
begin
    ...
    begin
        ...
        CMatrixGEMM(M-M1, N-M1, M1, C_Complex(-1.0), A, Offs+M1, Offs, 0, A, Offs, Offs+M1, 0, C_Complex(+1.0), A, Offs+M1, Offs+M1);
...
begin
    ...
    begin
        ...
        CMatrixGEMM(M-N1, N-N1, N1, C_Complex(-1.0), A, Offs+N1, Offs, 0, A, Offs, Offs+N1, 0, C_Complex(+1.0), A, Offs+N1, Offs+N1);
