...
procedure MinLBFGSCreate(N: AlglibInteger; M: AlglibInteger; const X: TReal1DArray; var State: MinLBFGSState);
procedure MinLBFGSSetCond(var State: MinLBFGSState; EpsG: AlglibFloat; EpsF: AlglibFloat; EpsX: AlglibFloat;
  MaxIts: AlglibInteger);
procedure MinLBFGSSetXRep(var State: MinLBFGSState; NeedXRep: Boolean);
procedure MinLBFGSSetStpMax(var State: MinLBFGSState; StpMax: AlglibFloat);
procedure MinLBFGSCreateX(N: AlglibInteger; M: AlglibInteger; const X: TReal1DArray; Flags: AlglibInteger;
  var State: MinLBFGSState);
function MinLBFGSIteration(var State: MinLBFGSState): Boolean;
procedure MinLBFGSResults(const State: MinLBFGSState; var X: TReal1DArray; var Rep: MinLBFGSReport);
procedure MinLBFGSFree(var X: TReal1DArray; var State: MinLBFGSState);
...
lbl_6:
  ...
  MCSRCH(N, State.X, State.F, State.G, State.D, State.Stp, State.StpMax, MCINFO, State.NFEV, State.WORK, State.LState,
    State.MCStage);
lbl_8:
