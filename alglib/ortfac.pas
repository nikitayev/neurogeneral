    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // Q' = E + Y*T'*Y' = E + TmpA*TmpT'*TmpA'
                //
                CMatrixGEMM(BlockSize, N-BlockStart-BlockSize, RowsCount, C_Complex(1.0), TmpA, 0, 0, 2, A, BlockStart, BlockStart+BlockSize, 0, C_Complex(0.0), TmpR, 0, 0);
                CMatrixGEMM(BlockSize, N-BlockStart-BlockSize, BlockSize, C_Complex(1.0), TmpT, 0, 0, 2, TmpR, 0, 0, 0, C_Complex(0.0), TmpR, BlockSize, 0);
                CMatrixGEMM(RowsCount, N-BlockStart-BlockSize, BlockSize, C_Complex(1.0), TmpA, 0, 0, 0, TmpR, BlockSize, 0, 0, C_Complex(1.0), A, BlockStart, BlockStart+BlockSize);
            end
            else
            begin
    ...
    begin
        ...
        begin
            ...
            begin
                ...
                // Q  = E + Y*T*Y'  = E + TmpA'*TmpT*TmpA
                //
                CMatrixGEMM(M-BlockStart-BlockSize, BlockSize, ColumnsCount, C_Complex(1.0), A, BlockStart+BlockSize, BlockStart, 0, TmpA, 0, 0, 2, C_Complex(0.0), TmpR, 0, 0);
                CMatrixGEMM(M-BlockStart-BlockSize, BlockSize, BlockSize, C_Complex(1.0), TmpR, 0, 0, 0, TmpT, 0, 0, 0, C_Complex(0.0), TmpR, 0, BlockSize);
                CMatrixGEMM(M-BlockStart-BlockSize, ColumnsCount, BlockSize, C_Complex(1.0), TmpR, 0, BlockSize, 0, TmpA, 0, 0, 0, C_Complex(1.0), A, BlockStart+BlockSize, BlockStart);
            end
            else
            begin
...
begin
    ...
    begin
        ...
        begin
            ...
            // Q  = E + Y*T*Y'  = E + TmpA*TmpT*TmpA'
            //
            CMatrixGEMM(BlockSize, QColumns, RowsCount, C_Complex(1.0), TmpA, 0, 0, 2, Q, BlockStart, 0, 0, C_Complex(0.0), TmpR, 0, 0);
            CMatrixGEMM(BlockSize, QColumns, BlockSize, C_Complex(1.0), TmpT, 0, 0, 0, TmpR, 0, 0, 0, C_Complex(0.0), TmpR, BlockSize, 0);
            CMatrixGEMM(RowsCount, QColumns, BlockSize, C_Complex(1.0), TmpA, 0, 0, 0, TmpR, BlockSize, 0, 0, C_Complex(1.0), Q, BlockStart, 0);
        end
        else
        begin
...
begin
    ...
    begin
        ...
        begin
            ...
            // Q'  = E + Y*T'*Y'  = E + TmpA'*TmpT'*TmpA
            //
            CMatrixGEMM(QRows, BlockSize, ColumnsCount, C_Complex(1.0), Q, 0, BlockStart, 0, TmpA, 0, 0, 2, C_Complex(0.0), TmpR, 0, 0);
            CMatrixGEMM(QRows, BlockSize, BlockSize, C_Complex(1.0), TmpR, 0, 0, 0, TmpT, 0, 0, 2, C_Complex(0.0), TmpR, 0, BlockSize);
            CMatrixGEMM(QRows, ColumnsCount, BlockSize, C_Complex(1.0), TmpR, 0, BlockSize, 0, TmpA, 0, 0, 0, C_Complex(1.0), Q, 0, BlockStart);
        end
        else
        begin
