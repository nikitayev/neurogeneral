...
/////////////////////////////////////////////////////////////////////////
function AbsReal(X : AlglibFloat):AlglibFloat;
function AbsInt (I : AlglibInteger):AlglibInteger;
function RandomReal():AlglibFloat;
function RandomInteger(I : AlglibInteger):AlglibInteger;
function Sign(X:AlglibFloat):AlglibInteger;
function AP_Sqr(X:AlglibFloat):AlglibFloat;
...
function AbsComplex(const Z : Complex):AlglibFloat;
function Conj(const Z : Complex):Complex;
function CSqr(const Z : Complex):Complex;

function C_Complex(const X : AlglibFloat):Complex;
...
function C_AddR(const Z1 : Complex; const R : AlglibFloat):Complex;
function C_MulR(const Z1 : Complex; const R : AlglibFloat):Complex;
function C_Sub(const Z1 : Complex; const Z2 : Complex):Complex;
function C_SubR(const Z1 : Complex; const R : AlglibFloat):Complex;
function C_RSub(const R : AlglibFloat; const Z1 : Complex):Complex;
function C_Div(const Z1 : Complex; const Z2 : Complex):Complex;
function C_DivR(const Z1 : Complex; const R : AlglibFloat):Complex;
function C_RDiv(const R : AlglibFloat; const Z2 : Complex):Complex;
function C_Equal(const Z1 : Complex; const Z2 : Complex):Boolean;
function C_NotEqual(const Z1 : Complex; const Z2 : Complex):Boolean;
function C_EqualR(const Z1 : Complex; const R : AlglibFloat):Boolean;
function C_NotEqualR(const Z1 : Complex; const R : AlglibFloat):Boolean;
...
function APVDotProduct(
   ...
   V2: PDouble; I21, I22: AlglibInteger):AlglibFloat;
procedure APVMove(
...
// compiler switch
/////////////////////////////////////////////////////////////////////////
function AP_Double(X:AlglibFloat):AlglibFloat;
function AP_FP_Eq(X:AlglibFloat; Y:AlglibFloat):Boolean;
function AP_FP_NEq(X:AlglibFloat; Y:AlglibFloat):Boolean;
function AP_FP_Less(X:AlglibFloat; Y:AlglibFloat):Boolean;
function AP_FP_Less_Eq(X:AlglibFloat; Y:AlglibFloat):Boolean;
function AP_FP_Greater(X:AlglibFloat; Y:AlglibFloat):Boolean;
function AP_FP_Greater_Eq(X:AlglibFloat; Y:AlglibFloat):Boolean;

{var
    // pointers to AP BLAS functions
    ASMDotProduct1: function(V1: PDouble; V2: PDouble; N: AlglibInteger):AlglibFloat;cdecl;
    ASMMove1: procedure(VDst: PDouble; VSrc: PDouble; N: AlglibInteger);cdecl;
    ASMMoveS1: procedure(VDst: PDouble; VSrc: PDouble; N: AlglibInteger; S: AlglibFloat);cdecl;
    ...
    ASMAddS1: procedure(VDst: PDouble; VSrc: PDouble; N: AlglibInteger; S: AlglibFloat);cdecl;
