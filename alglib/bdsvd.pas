...
function ExtSignBDSQR(a : AlglibFloat; b : AlglibFloat):AlglibFloat;forward;
procedure Svd2X2(F : AlglibFloat;
     G : AlglibFloat;
     H : AlglibFloat;
     var SSMIN : AlglibFloat;
     var SSMAX : AlglibFloat);forward;
procedure SvdV2X2(F : AlglibFloat;
     G : AlglibFloat;
     H : AlglibFloat;
     var SSMIN : AlglibFloat;
     var SSMAX : AlglibFloat;
     var SNR : AlglibFloat;
     var CSR : AlglibFloat;
     var SNL : AlglibFloat;
     var CSL : AlglibFloat);forward;
...
begin
    ...
    begin
        ...
        //
        if AP_FP_Greater_Eq(TOL,0) and AP_FP_Less_Eq(N*TOL*(SMINL/SMAX),Max(EPS, 0.01*TOL)) then
        begin
...
function ExtSignBDSQR(a : AlglibFloat; b : AlglibFloat):AlglibFloat;
begin
